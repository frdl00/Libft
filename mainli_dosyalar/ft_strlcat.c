...
//size: dst bufferının toplam uzunluğudur, bufferda ne kadar boş yer kaldığını hesaplar ve src yi kalan boş yer kadar ekler
//yani ekleme sınırı = size - stlen -1
//dst i sonuna kadar ölçmeye gerek yok
//dst_len → güvenlik için size ile sınırlı ölçülür
//src_len → return değeri için TAM ölçülür
